...
class PongGame:
    def __init__(self,parent=None):
        ...
        # self.score=[0,0]
        # self.sceneView.scene.addLine(100,200,100,100)
        # self.sceneView.scene.addLine(self.boundary[0]/2,0,self.boundary[0]/2,self.boundary[1]*2)
...
##            print 'leftpaddlecollide'
    ...
    def ballHitsWalls(self):
        z = self.sceneView.scene.collidingItems(self.ball)
        if self.ball.x() < 0 or self.ball.x() > 700:
            return True
        pass
